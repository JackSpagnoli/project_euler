fn main() {
    ...
    while i < 78498 {
        ...
        if primes[i] != 0 {
            //println!("Considering n={}", primes[i]);
            ...
            while cycler != primes[i] {
                ...
                if index.is_ok() {
                    ...
                    //println!("Added index {}",index.unwrap());
                    cycler = cycle(cycler);
                } else {
            ...
            if circular_prime {
                //println!("Found {} is a circular prime", primes[i]);
    ...
    println!("Found {} circular primes", circular_primes);
}
...
fn cycle(n: u32) -> u32 {
    ...
    //println!("i:{}, last_digit:{}, remainder:{}", i, last_digit, remainder);
